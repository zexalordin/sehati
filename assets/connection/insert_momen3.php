<?php 
	if($_SERVER['REQUEST_METHOD']=='POST'){
		...
		if ($image!=null) {
			...
			$sql = "INSERT INTO momen (photo_momen,caption_momen,id_user,status_momen) VALUES ('$actualpath','$caption_momen','$id_user','foto')";
			...
			$sql = "INSERT INTO momen (caption_momen,id_user,status_momen) VALUES ('$caption_momen','$id_user','caption')";
