<?php 
	if($_SERVER['REQUEST_METHOD']=='POST'){
		...
		$sql = "SELECT * FROM tips_kehamilan INNER JOIN kategori_tips_kehamilan	ON  tips_kehamilan.id_kategori_tips = kategori_tips_kehamilan.id_kategori_tips WHERE post_tips='$minggu' ORDER BY nama_kategori_tips ASC";
