...
$(document).on("click", ".open-AddBookDialog", function () {
     id = $(this).data('id');
     var base = getBaseUrl();
     $("#delete").attr("href", base+"index.php/crud/delete_jadwal_static/"+id);
});
function getBaseUrl() {
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="card col-md-12" style="">
                        <h1 align="center">Data Post Jadwal Static</h1><br>
                        <?php 
                        ...
                        <br>
                        <a href="<?php echo base_url()."index.php/sehati/tambah_post_jadwal_static"?>">
                                ...
                                <table class="table table-hover">
                                    ...
                                    foreach ($data as $d) {?>
                                      <tr>
                                        ...
                                        <td><?php echo $d->judul_detail_jadwal ?></td>
                                        <td><?php echo $d->post_jadwal ?></td>
                                        <td>
                                            <a href="<?php echo base_url()."index.php/sehati/edit_jadwal_static/".$d->id_jadwal_static?>">
                                                <span class="glyphicon glyphicon-edit" style="font-size: 20px;"></span>
                                            </a>
                                            <a data-toggle="modal" data-id="<?php echo $d->id_jadwal_static ?>" class="open-AddBookDialog" href="#" data-target="#myModal">
