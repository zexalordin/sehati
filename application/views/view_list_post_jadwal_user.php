...
$(document).on("click", ".open-AddBookDialog", function () {
     id = $(this).data('id');
     var base = getBaseUrl();
     $("#delete").attr("href", base+"index.php/crud/delete_jadwal_user/"+id);
});
function getBaseUrl() {
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="card col-md-12" style="">
                        ...
                        <br>
                        <a href="<?php echo base_url()."index.php/sehati/tambah_post_jadwal_user"?>">
                                ...
                                <table class="table table-hover">
                                    ...
                                    foreach ($data as $d) {?>
                                      <tr>
                                        ...
                                        <td><?php echo $d->waktu_pertemuan ?></td>
                                        <td><?php echo $d->status_jadwal ?></td>
                                        <td>
                                            <a href="<?php echo base_url()."index.php/sehati/edit_jadwal_user/".$d->id_jadwal_user?>">
                                                <span class="glyphicon glyphicon-edit" style="font-size: 20px;"></span>
                                            </a>
                                            <a data-toggle="modal" data-id="<?php echo $d->id_jadwal_user ?>" class="open-AddBookDialog" href="#" data-target="#myModal">
