...
$(document).on("click", ".open-AddBookDialog", function () {
     id = $(this).data('id');
     var base = getBaseUrl();
     $("#delete").attr("href", base+"sehati/index.php/crud/delete_kategori_tips_kehamilan/"+id);
});
function getBaseUrl() {
...
$(document).ready(function(){  
      $('#search_text').keyup(function(){
           ...
           if(txt != ''){  
                $.ajax({  
                     url:"kategori_tips_kehamilan_table",  
                     method:"post",  
                     data:{search:txt},  
                     dataType:"text",  
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="card col-md-12" style="">
                        <h1 align="center">Data Kategori Tips Kehamilan</h1><br>
                        <?php 
                        ...
                        <br>
                        <a href="<?php echo base_url()."index.php/sehati/tambah_post_kategori_tips_kehamilan"?>">
                                ...
                                <table class="table table-hover">
                                    ...
                                    foreach ($data as $d) {?>
                                      <tr>
                                        ...
                                        <td><img src="<?php echo $d->photo_kategori_tips ?>" style="width: 100px;border-style: ridge;border-width: 1px;"></td>
                                        <td>
                                            ...
                                            <a data-toggle="modal" data-id="<?php echo $d->id_kategori_tips ?>" class="open-AddBookDialog" href="#" data-target="#myModal">
