            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-10" style="">
                        <h1 align="center">Form Input Post Kategori Kategori Barang Statis</h1><br>
                        <?php 
                        ...
                        <!--FORM-->
                        <form method="POST" action="<?php echo base_url()."index.php/crud/tambah_kategori_kategori_barang_statis"?>">
