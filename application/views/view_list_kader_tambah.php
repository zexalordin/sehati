            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-6" style="">
                        <h1 align="center">Form Input Data Kader</h1><br>
                        <?php 
                        ...
                        <!--FORM-->
                        <form method="POST" action="<?php echo base_url()."index.php/crud/tambah_kader"?>" enctype="multipart/form-data">
                          ...
                          <div class="form-group">
                            ...
                            <input type="number" name="kontak_kader" class="form-control" id="formGroupExampleInput2" placeholder="e.g. 087xxxxxxxxx" required>
                          </div>
                          <div class="form-group">
