            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-10" style="">
                        <h1 align="center">Form Input Post Kategori Tips Kehamilan</h1><br>
                        <?php 
                        ...
                        <!--FORM-->
                        <form method="POST" action="<?php echo base_url()."index.php/crud/tambah_kategori_tips_kehamilan"?>" enctype="multipart/form-data">
