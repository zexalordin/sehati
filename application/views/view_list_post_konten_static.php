...
$(document).on("click", ".open-AddBookDialog", function () {
     id = $(this).data('id');
     var base = getBaseUrl();
     $("#delete").attr("href", base+"sehati/index.php/crud/delete_konten_static/"+id);
});
function getBaseUrl() {
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="card col-md-12" style="">
                        <h1 align="center">Data Post Konten Static</h1><br>
                        <?php 
                        ...
                        <br>
                        <a href="<?php echo base_url()."index.php/sehati/tambah_post_konten_static"?>">
                            ...
                            <div class="content table-responsive table-full-width" style="margin-top: 50px;">
                                <table class="table table-hover">
                                    ...
                                    foreach ($data as $d) {?>
                                      <tr>
                                        <td><?php echo $i?></td>
                                        <td><?php echo $d->judul_konten_static ?></td>
                                        <td><?php echo $d->status_konten_static ?></td>
                                        <td>
                                            <a href="<?php echo base_url()."index.php/sehati/edit_konten_static/".$d->id_konten_static ?>">
                                                <span class="glyphicon glyphicon-edit" style="font-size: 20px;"></span>
                                            </a>
                                            <a data-toggle="modal" data-id="<?php echo $d->id_konten_static ?>" class="open-AddBookDialog" href="#" data-target="#myModal">
