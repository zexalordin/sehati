...
$(document).on("click", ".open-AddBookDialog", function () {
     id = $(this).data('id');
     var base = getBaseUrl();
     $("#delete").attr("href", base+"index.php/crud/delete_kehamilanku/"+id);
});
function getBaseUrl() {
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="card col-md-12" style="">
                        <h1 align="center">Data Post Kehamilanku</h1><br>
                        <?php 
                        ...
                        <br>
                        <a href="<?php echo base_url()."index.php/sehati/tambah_post_kehamilanku"?>">
                                ...
                                <table class="table table-hover">
                                    ...
                                    foreach ($data as $d) {?>
                                      <tr>
                                        ...
                                        <td><img src="<?php echo $d->photo_artikel ?>" style="width: 100px;border-style: ridge;border-width: 1px;"></td>
                                        <td><?php echo $d->tanggal_artikel ?></td>
                                        <td><?php echo $d->post_artikel ?></td>
                                        <td>
                                            <a href="<?php echo base_url()."index.php/sehati/edit_post/".$d->id_artikel?>">
                                                <span class="glyphicon glyphicon-edit" style="font-size: 20px;"></span>
                                            </a>
                                            <a data-toggle="modal" data-id="<?php echo $d->id_artikel ?>" class="open-AddBookDialog" href="#" data-target="#myModal">
