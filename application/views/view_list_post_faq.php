...
$(document).on("click", ".open-AddBookDialog", function () {
     id = $(this).data('id');
     var base = getBaseUrl();
     $("#delete").attr("href", base+"index.php/crud/delete_faq/"+id);
});
function getBaseUrl() {
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="card col-md-12" style="">
                        <h1 align="center">Data Post FAQ</h1><br>
                        <?php 
                        ...
                        <br>
                        <a href="<?php echo base_url()."index.php/sehati/tambah_post_faq"?>">
                            ...
                            <div class="content table-responsive table-full-width" style="margin-top: 50px;">
                                <table class="table table-hover">
                                    ...
                                    foreach ($data as $d) {?>
                                      <tr>
                                        <td><?php echo $i?></td>
                                        <td><?php echo $d->judul_faq ?></td>
                                        <td><?php echo $d->post_faq ?></td>
                                        <td>
                                            <a href="<?php echo base_url()."index.php/sehati/edit_faq/".$d->id_faq ?>">
                                                <span class="glyphicon glyphicon-edit" style="font-size: 20px;"></span>
                                            </a>
                                            <a data-toggle="modal" data-id="<?php echo $d->id_faq ?>" class="open-AddBookDialog" href="#" data-target="#myModal">
