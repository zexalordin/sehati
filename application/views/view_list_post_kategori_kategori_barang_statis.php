...
$(document).on("click", ".open-AddBookDialog", function () {
     id = $(this).data('id');
     var base = getBaseUrl();
     $("#delete").attr("href", base+"sehati/index.php/crud/delete_kategori_kategori_barang_statis/"+id);
});
function getBaseUrl() {
...
$(document).ready(function(){  
      $('#search_text').keyup(function(){
           ...
           if(txt != ''){  
                $.ajax({  
                     url:"kategori_kategori_barang_statis_table",  
                     method:"post",  
                     data:{search:txt},  
                     dataType:"text",  
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="card col-md-12" style="">
                        <h1 align="center">Data Kategori Kategori Barang</h1><br>
                        <?php 
                        ...
                        <br>
                        <a href="<?php echo base_url()."index.php/sehati/tambah_post_kategori_kategori_barang_statis"?>">
                            ...
                            <div class="content table-responsive table-full-width" style="margin-top: 50px;">
                                <table class="table table-hover">
                                    ...
                                    foreach ($data as $d) {?>
                                      <tr>
                                        <td><?php echo $i?></td>
                                        <td><?php echo $d->nama_kategori_kategori_barang_statis ?></td>
                                        <td>
                                        <a href="<?php echo base_url()."index.php/sehati/edit_post_kategori_kategori_barang_statis/".$d->id_kategori_kategori_barang_statis?>">
                                                <span class="glyphicon glyphicon-edit" style="font-size: 20px;"></span>
                                            </a>
                                            <a data-toggle="modal" data-id="<?php echo $d->id_kategori_kategori_barang_statis ?>" class="open-AddBookDialog" href="#" data-target="#myModal">
