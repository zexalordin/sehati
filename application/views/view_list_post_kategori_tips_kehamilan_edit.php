            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-10" style="">
                        <h1 align="center">Form Edit Post Kategori Tips Kehamilan</h1><br>
                        <?php 
                        ...
                        <!--FORM-->
                        <form method="POST" action="<?php echo base_url()."index.php/crud/edit_kategori_tips_kehamilan/".$data->id_kategori_tips ?>" enctype="multipart/form-data">
                          <div class="form-group">
                                <label for="formGroupExampleInput2">Nama Kategori</label>
                                <input name="nama_kategori" type="text" class="form-control" id="formGroupExampleInput2" value="<?php echo $data->nama_kategori_tips ?>" required>
                          </div>
