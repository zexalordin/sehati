            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-10" style="">
                        <h1 align="center">Form Input Post Tips Kehamilan</h1><br>
                        <?php 
                        ...
                        <!--FORM-->
                        <form method="POST" action="<?php echo base_url()."index.php/crud/tambah_tips_kehamilan"?>" enctype="multipart/form-data">
                          ...
                          <div class="form-group">
                                ...
                                <input name="sumber" type="text" class="form-control" id="formGroupExampleInput2">
                          </div>
