...
$(document).on("click", ".open-AddBookDialog", function () {
     id = $(this).data('id');
     var base = getBaseUrl();
     $("#delete").attr("href", base+"index.php/crud/delete_kader/"+id);
});
function getBaseUrl() {
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="card col-md-12" style="">
                        <h1 align="center">Data kader</h1><br>
                        <?php 
                        ...
                        <br>
                        <a href="<?php echo base_url()."index.php/sehati/tambah_kader"?>">
                            ...
                            <div class="content table-responsive table-full-width" style="margin-top: 50px;">
                                <table class="table table-hover">
                                    ...
                                    foreach ($data as $d) {?>
                                      <tr>
                                        <td><?php echo $i?></td>
                                        <td><?php echo $d->nama_kader ?></td>
                                        <td><?php echo $d->rate ?></td>
                                        <td><?php echo $d->kontak_kader ?></td>
                                        <td><?php echo $d->nama_bidan ?></td>
                                        <td><img src="<?php echo $d->foto_kader ?>" style="width: 100px;border-style: ridge;border-width: 1px;"></td>
                                        <td>
                                            <a href="<?php echo base_url()."index.php/sehati/edit_kader/".$d->id_kader?>">
                                                <span class="glyphicon glyphicon-edit" style="font-size: 20px;"></span>
                                            </a>
                                            <a data-toggle="modal" data-id="<?php echo $d->id_kader ?>" class="open-AddBookDialog" href="#" data-target="#myModal">
