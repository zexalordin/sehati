  ...
  if($count>=1){
      ...
      foreach ($data as $d){  
           $output .= '  
                <tr>
                  <td>'.$i.'</td>
                  <td>'.$d->judul_konten_static.'</td>
                  <td>'.$d->status_konten_static.'</td>
                  <td>
                    <a href="'.base_url()."edit_konten_static/".$d->id_konten_static.'">
                      <span class="glyphicon glyphicon-edit" style="font-size: 20px;"></span>
                    </a>
                    <a data-toggle="modal" data-id="'.$d->id_konten_static.'" class="open-AddBookDialog" href="#" data-target="#myModal">
