            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-10" style="">
                        <h1 align="center">Form Edit Post Kategori Barang Statis</h1><br>
                        <?php 
                        ...
                        <!--FORM-->
                        <form method="POST" action="<?php echo base_url()."index.php/crud/edit_kategori_barang_statis/".$data->id_kategori_barang_statis?>">
                          <div class="form-group">
                                <label for="formGroupExampleInput2">Nama Kategori</label>
                                <input name="nama_kategori" type="text" class="form-control" id="formGroupExampleInput2" required value="<?php echo $data->nama_kategori_barang_statis ?>">
                          </div>
                          <div class="form-group">
                                ...
                                <select class="form-control" id="sel1" name="kategori_kategori">
                                    <?php foreach ($data_kategori as $d){
                                        if($d['id_kategori_kategori_barang_statis'] == $data->id_kategori_kategori_barang_statis){?>
                                        <option value="<?php echo $d['id_kategori_kategori_barang_statis'] ?>" selected><?php echo $d['nama_kategori_kategori_barang_statis'] ?></option>
                                        <?php }else{ ?>
